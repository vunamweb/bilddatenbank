...
<script src="<?php echo $dir; ?>js/bootstrap-select.min.js"></script>
...
<script src="<?php echo $dir; ?>js/semantic.js" type="text/javascript"></script>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $('.add_button, .add_folder').click(function() {
      var name = $('#name').val();
