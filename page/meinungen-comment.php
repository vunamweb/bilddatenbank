...
if($meinungen) {
	...
	$zielSeite = "meinungen";
	$backLink = $dir.'?hn='.$zielSeite.'&cont='.$zielSeite.'&topic='.$topic;
...
';
	...
	$output .= '
					<div class="col-md-8">
						...
						<p class="erstellt">Erstellt: '.euro_dat($row->datum).'</p>
					</div>
...
'.$comments;
	...
	$output .= '
						<textarea class="form-control mt4" id="comment" ref="'.$meinungen.'" placeholder="Mein Kommentar"></textarea>
						<button class="btn btn-info saveText" ref="'.$meinungen.'"><i class="fa fa-save"></i></button>
