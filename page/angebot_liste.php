...
while($row = mysqli_fetch_object($res)) {
	...
	<div class="row borderBottom">
		...
		<div class="col-sm-1">
			<p>
			<sapn class="sichtbar"><i class="fa fa-eye'.($row->sichtbar ? '' : '-slash').' tool '.($row->sichtbar ? '' : 'tool-white').' state" ref="'.$row->aid.'"></i></span><br/><br/>
			<a href="'.$dir.$navID[21].'edit+'.$row->aid.'/"><i class="fa fa-pencil tool"></i></a><br/><br/>
			<a href="'.$dir.$navID[21].'deljob-'.$row->aid.'+'.$row->aid.'/"><i class="fa fa-eraser tool warn"></i></a>
			</p>
		</div>
	</div>
