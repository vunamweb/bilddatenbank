...
<!-- 									<li><a href="morp_blog.php" title="Text-Vorlagen verwalten"><i class="fa fa-comments-o "></i> Blog</a></li> -->
					...
					<li><a href="../admin/timetable/list.php" title="Kalender verwalten"><i class="fa fa-calendar"></i> Termine / Kalender</a></li>

					<li class="panel panel-default" id="dropdown">
					    <a data-toggle="collapse" href="#dropdown-lvl3">
					        <i class="fa fa-calendar "></i> Events / Veranstaltungen <span class="caret"></span>
					    </a>
					    <div id="dropdown-lvl3" class="panel-collapse collapse">
					        <div class="panel-body">
					            <ul class="nav navbar-nav">
									<li><a href="morp_event.php" title="Kalender verwalten"><i class="fa fa-calendar"></i> Events verwalten</a></li>
									<li><a href="morp_event_zusagen.php" title="Zusagen"><i class="fa fa-user"></i> Zusagen</a></li>
					            </ul>
					        </div>
					    </div>
					</li>
				...
				<!--	<li><a href="sitemap_erstelle.php" title="index erstellen"><i class="fa fa-sort-alpha-asc"></i> Sitemap/Index erstellen</a></li>-->
					...
					<li class="panel panel-default" id="dropdown">
					    ...
					    <div id="dropdown-lvl2" class="panel-collapse collapse">
					        <div class="panel-body">
					            <ul class="nav navbar-nav">
									<li><a href="user_intranet.php" title=""><i class="fa fa-users "></i> Intranet Mitarbeiter</a></li>
