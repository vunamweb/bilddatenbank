...
elseif ($copy) {
	...
	$sql	= "INSERT `morp_cms_content` set navid=$edit, tpos=$y, theadl='$th', content='$de', tid='$tid', tlink='$tlink', tbackground='$tb', timage='$timage', theight='$theight', twidth='$twidth', tref='$tref'";
	$res	= safe_query($sql);
